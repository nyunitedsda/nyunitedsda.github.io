export type AnnouncementDTDate_format = "YYYY-MM-DD" | "MM/DD/YYYY" | "DD-MM-YYYY" | "MMM D, YYYY" | "dddd, h:mm a";
...
export type SeverityDTColor = "info" | "error" | "warning" | "success" | "primary" | "secondary";
