        ...
        {isLive ? (
          ...
          <Grid container spacing={4} justifyContent="center">
            <Grid size={{ xs: 12, md: 8 }} className="fade-in">
              <Paper elevation={3} sx={{ p: 4, bgcolor: "background.paper", borderRadius: 2, textAlign: "center" }}>
            ...
            <Grid size={{ xs: 12, md: 8 }} className="fade-in">
              <Paper elevation={3} sx={{ p: 4, mt: 4, bgcolor: "background.paper", borderRadius: 2 }}>
