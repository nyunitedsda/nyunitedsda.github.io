  ...
  return (
    <PageWrapper>
      <Stack
        ...
        className="fade-in"
      >
        <ErrorOutlineOutlined sx={{ fontSize: 80, color: "error.main", mb: 2 }} />
        ...
        <Typography
          ...
          variant="body1"
          dangerouslySetInnerHTML={{ __html: '"The LORD is my strength and my shield; my heart trusts in him, and he helps me." - <i>Psalm 28:7</i>' }}
        />
