...
export const METRO = "Metro & Bus";
export const TRIP_PLANNER = "Trip Planner";
export const DRIVING_DIRECTION = "​DRIVING DIRECTIONS";
...
export const SERVICES = "Service Times";
