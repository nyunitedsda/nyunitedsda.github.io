...
const LENOX_AVE = 'Coming from Lenox Ave, if you reach 5th Ave, you\'ve gone too far!'
const BRIDGE = 'Coming from Brooklyn Bridge, If you reach W 130th St you\'ve gone a little too far. 163 W 131ST ST is on the right. If you reach Adam Clayton Powell Jr Blvd you\'ve gone a little too far'
  ...
  return (
    <PageWrapper header={HEADER} subHeader={SUBHEADER}>
      ...
      <Paper elevation={3} sx={{ p: 4, mb: 2, mt: 4 }}>
        <Typography variant="h5" sx={{ mb: 4, color: "primary.main", fontWeight: "bold" }}>
          {COMPANY}
        </Typography>
      ...
      <Paper elevation={3} sx={{ p: 2, minHeight: "450px", overflow: "hidden", display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 2, mt: 2 }}>
        ...
        <Stack sx={{ p: 2, height: { xs: 'auto', md: '100%' }, gap: 2, width: { xs: '100%', md: '50%' } }}>
          <Stack>
            <Typography variant='h6' fontWeight={'bold'}>{METRO}</Typography>
            <Typography
              component={'a'}
          ...
          <Stack sx={{ width: '100%' }}>
            <Typography variant='h6' fontWeight={'bold'}>{DRIVING_DIRECTION}</Typography>
            <List>
