...
export const Default: Story = {
  ...
  decorators: decorators,
	parameters: {
		docs: {
			description: {
				story: "Standard login button with LoginOutlined icon and primary color theme.",
			},
		},
	},
};
...
export const Focused: Story = {
  ...
  decorators: decorators,
	parameters: {
		docs: {
			description: {
				story: "Login button in focused state with keyboard navigation support.",
			},
		},
		pseudo: {
			focus: true,
...
export const Interactive: Story = {
  ...
  decorators: decorators,
	...
	parameters: {
		docs: {
			description: {
				story: "Interactive testing story that verifies button functionality and navigation behavior.",
			},
		},
	},
};
...
export const FullWidth: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Login button taking full width of its container for responsive layouts.",
			},
		},
	},
};
...
export const DarkTheme: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Login button displayed in dark theme to verify color contrast and readability.",
			},
		},
		backgrounds: {
			default: "dark",
...
export const AccessibilityTest: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Automated accessibility testing for keyboard navigation, ARIA compliance, and WCAG standards.",
			},
		},
	},
};
