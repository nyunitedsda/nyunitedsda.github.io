...
const MockNotificationContext = ({ children }: { children: React.ReactNode }) => {
  const mockContextValue = {
    notifications: [],
    registerNotification: () => {},
    dismissNotification: (id: number) => console.log("Notification dismissed:", id),
    clearNotification: () => {},
  };
...
const NotificationDecorator = (Story: any, context: any) => {
  ...
  return React.createElement(
    ...
    { children: null },
    showContainer ? React.createElement(
      Box,
      {
        sx: {
          width: "100%",
...
export const Default: Story = {
  ...
  args: {
    id: 1,
    message: "Welcome to New York United SDA Church! Join us for worship this Saturday at 11:00 AM.",
    open: true,
...
export const WithTitle: Story = {
  ...
  args: {
    ...
    message: "Special prayer meeting scheduled for this Wednesday at 7:00 PM in the main sanctuary.",
    open: true,
    severity: "information",
  },
  parameters: {
...
export const Success: Story = {
  ...
  args: {
    ...
    message: "Thank you for your generous donation of $100. Your contribution helps support our ministry.",
    open: true,
    severity: "success",
  },
  parameters: {
...
export const Warning: Story = {
  ...
  args: {
    ...
    message: "Please note that next Saturday's service will start 30 minutes later due to a special program.",
    open: true,
    severity: "caution",
  },
  parameters: {
...
export const Interactive: Story = {
  ...
  args: {
    ...
    message: "Click the close button to dismiss this notification. Use the controls below to customize it.",
    open: true,
    severity: "information",
  },
  parameters: {
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(NotificationBanner, {
            ...
            message: "Join us this Saturday for a special communion service starting at 11:00 AM. Elder Johnson will be delivering the sermon.",
            open: true,
            severity: "information",
          }),
          React.createElement(NotificationBanner, {
            ...
            message: "Registration is now open for our summer youth camp. Early bird pricing available until March 15th.",
            open: true,
            severity: "success",
          }),
          React.createElement(NotificationBanner, {
            id: 203,
            message: "Prayer meeting moved to Fellowship Hall due to sanctuary maintenance.",
            open: true,
            severity: "caution",
          }),
          React.createElement(NotificationBanner, {
            ...
            message: "Join us next Sunday for our monthly food distribution program. Volunteers needed from 9:00 AM to 12:00 PM.",
            open: true,
            severity: "information",
          })
        )
...
export const ResponsiveDemo: Story = {
  ...
  args: {
    ...
    message: "This notification adapts to different screen sizes and maintains readability on all devices.",
    open: true,
    severity: "information",
  },
  parameters: {
