    ...
    <Box sx={{ bgcolor: "background.default", minHeight: "100vh" }}>
      ...
      <Box sx={{ p: 3, mt: 2 }}>
        <Box sx={{ 
          ...
          Content area below header - The header is sticky and will remain at the top when scrolling.
        </Box>
      </Box>
    </Box>
  );
...
export const HomePage: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Header on the home page. Navigation state depends on the current route in the app.",
      },
    },
  },
};
...
export const AboutPage: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Header showing navigation. Active state will reflect the current application route.",
      },
    },
  },
};
...
export const BlogPage: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Header for the blog section with navigation to all church pages.",
      },
    },
  },
};
    ...
    (Story) => (
      <Box>
        <Box sx={{ 
          ...
          <br />
          Resize the viewport to see the header adapt between mobile and desktop layouts
        </Box>
        <Story />
      </Box>
    ),
    ...
    (Story) => (
      <Box>
        <Box sx={{ 
          ...
          <br />
          Try clicking navigation items, the theme toggle button, and the hamburger menu (on mobile)!
        </Box>
        <Story />
        ...
        {Array.from({ length: 20 }, (_, i) => (
          <Box key={i} sx={{ p: 2, mb: 1, bgcolor: "grey.50", borderRadius: 1 }}>
            Content section {i + 1} - The header remains sticky at the top while scrolling
          </Box>
        ))}
      </Box>
    ),
