...
vi.mock('./MenuDrawerItem', () => ({
  default: ({ text, isActive, onClick, disabled }: { text: string, isActive: boolean, onClick: React.MouseEventHandler<HTMLButtonElement>, disabled: boolean }) => (
    <button
      type="button"
...
vi.mock('./SubMenuDrawerItem', () => ({
  default: ({ name, isActiveParent, isActiveChild: _isActiveChild, onClick: _onClick }: { name: string, isActiveParent: boolean, isActiveChild: boolean, onClick: React.MouseEventHandler<HTMLDivElement> }) => (
    <div
