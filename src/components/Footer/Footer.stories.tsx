...
export const LightTheme: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Footer displayed with light theme styling from the app's theme system.",
      },
    },
  },
};
...
export const DarkTheme: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Footer displayed with dark theme styling from the app's theme system. Use the theme toggle in Storybook to see this variant.",
      },
    },
  },
};
    ...
    (Story) => (
      <Box>
        <Box sx={{ 
          ...
          <br />
          Try clicking on phone numbers, email addresses, and social media icons below!
        </Box>
        <Story />
      </Box>
    ),
